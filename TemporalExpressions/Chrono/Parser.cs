...
using System.Linq;
using TemporalExpressions.Chrono.Handlers;
using TemporalExpressions.Chrono.Handlers.Registers;
...
namespace TemporalExpressions.Chrono
{
    public class Parser
    {
        ...
        readonly HandlerRegistry _registry = new VaultixHandlerRegistry();
	   ...
	   * (depending on the value of <tt>phrase</tt>). If no date or time can be found,
	   ...
	   */
        ...
        // Processes all the tokens to prevoide a proper symlinking with
        // its tag.
